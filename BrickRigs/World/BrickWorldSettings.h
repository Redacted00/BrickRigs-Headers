...
public:
	...
	// A shared library of MIDs generated for each pattern used by all vehicles in the world
	TMap<UClass*, TMap<UMaterialInterface*, UMaterialInstanceDynamic*>> VehicleMIDs;
	// ~Variables
...
public:
	// Returns an existing MID or creates a new one if needed
	UMaterialInstanceDynamic* FindOrCreateVehicleMID(UClass* PatternClass, UMaterialInterface* ParentMaterial);
};
