...
public:
	...
	UFUNCTION(BlueprintCallable)
	int32 SpawnItems(TSubclassOf<AInventoryItem> ItemClass, int32 Amount)
	{
	...
	// Main function for moving items between inventories, picking up items or dropping them
	UFUNCTION(BlueprintCallable)
...
public:
	...
	// Get the amount of ammo compatible with the given ammo types
	UFUNCTION(BlueprintPure)
