...
protected:
	...
	TArray<FBrickEditorObjectPtr> PickedObjects;
...
private:
	...
	virtual EBrickEditorObjectAllowed IsObjectAllowed(const TArray<FBrickEditorObjectPtr>& Selection, const UBrickEditorObject* Object) const
	{
		return EBrickEditorObjectAllowed::No;
	}
...
public:
	// ~Super Interface
	virtual bool EndMode(bool bRevertChanges) override;
	virtual EBrickEditorObjectAllowed IsObjectAllowed(const TArray<FBrickEditorObjectPtr>& Selection, const UBrickEditorObject* Object) const override;
