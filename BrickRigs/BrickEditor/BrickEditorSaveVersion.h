...
public:
	...
	static FBrickRigsSaveVersion FromString(const FString& InString)
	{
		return FBrickRigsSaveVersion(FCString::Atoi(*InString));
	}

	FString ToString() const
	{
		return FString::FromInt(Version);
	}
...
const static FBrickRigsSaveVersion BR_SAVE_VERSION = 13;
