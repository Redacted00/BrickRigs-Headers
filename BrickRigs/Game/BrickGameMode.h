...
public:
	...
	virtual APlayerController* SpawnReplayPlayerController(ENetRole InRemoteRole, const FVector& SpawnLocation, const FRotator& SpawnRotation) override;
	virtual APlayerController* SpawnPlayerController(ENetRole InRemoteRole, const FVector& SpawnLocation, const FRotator& SpawnRotation) override;
...
public:
	...
	void OnPlayerSpawnedVehicle(const ABrickPlayerController* PC, const FUGCFileInfo& FileInfo) const;
	// Called when vehicle spawning has failed
	void OnVehicleSpawnFailed(ABrickPlayerController* SpawningPC, const FUGCFileInfo& FileInfo, const FVehicleSpawnProperties& Props, const EPlayerSpawnResult Reason);
	// ~Restarting
