...
USTRUCT()
struct FExtinguishAnimation : public FItemAnimation
{
	GENERATED_BODY()

	// Time at which the spraying starts
	UPROPERTY(EditAnywhere)
	float StartExtinguishTime = 0.25f;
	// Sound to play when stopping to spray
	UPROPERTY(EditAnywhere)
	USoundBase* StopExtinguishSound = nullptr;
};
