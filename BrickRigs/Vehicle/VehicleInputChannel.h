...
struct FVehicleInputChannel : public FBrickStructPropertyInterface
{
	...
	bool IsSourceBrickAllowed(const UBrickEditorObject* Object) const;

private:
	// Property callbacks
	static bool IsSourceBrickAllowed(const FBrickPropertyContainer& Container, const UBrickEditorObject* Object);
