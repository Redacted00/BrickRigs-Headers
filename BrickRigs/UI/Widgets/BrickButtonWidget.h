...
public:
	...
	// ~Constructor
	UBrickButtonWidget(const FObjectInitializer& ObjectInitializer);

	// ~Super Interface
	virtual void NativePreConstruct() override;
	virtual void OnIsFocusedChanged() override;
	...
	virtual void OnDoubleClicked(const FGeometry& InGeometry, const FPointerEvent& InMouseEvent) override;
