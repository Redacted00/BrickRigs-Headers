...
public:
	...
	UHUDNotificationWidget* AddHUDNotification(const FName& Context, bool bShouldFadeOut = true, bool* bOutWasVisible = nullptr);
...
private:
	...
	FName GetVehicleDownloadNotificationContext(ABrickVehicle* InVehicle) const;
