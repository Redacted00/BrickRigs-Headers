...
public:
	...
	// Initialize the ammo and chamber state
	void ResetAmmo(bool bStartCocked);
...
public:
	...
	void GetProjectileSpawnPoint(FVector& OutLocation, FRotator& OutRotation, FVector& OutVelocity, float DeltaTimeOffset, bool bIncludeSpread) const;
