...
public:
	...
	DECLARE_MULTICAST_DELEGATE_ThreeParams(FOnSpawnedVehicleDownloadProgressChanged, ABrickVehicle*, bool, float);
	DECLARE_MULTICAST_DELEGATE_OneParam(FOnSpawnedVehicleDestroyed, ABrickVehicle*);
...
public:
	...
	FOnSpawnedVehicleDownloadProgressChanged OnSpawnedVehicleDownloadProgressChangedDelegate;
	FOnSpawnedVehicleDestroyed OnSpawnedVehicleDestroyedDelegate;
...
public:
	// Called from spawned vehicles to notify the player that they are being destroyed
	void OnSpawnedVehicleDestroyed(ABrickVehicle* InVehicle);
	// Called from spawned vehicles when their download progress has changed
	void OnSpawnedVehicleDownloadProgressChanged(ABrickVehicle* InVehicle, bool bIsDownloading, float Progress);
...
public:
	// ~Kick List
	// Requests the given kicked player list page from the server, return true if the request was succesfully started
