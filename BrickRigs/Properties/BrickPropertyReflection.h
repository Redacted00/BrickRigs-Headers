...
public:
	...
	// Can be used in struct member reflection to keep the outer category
#define BRICK_PROPERTY_NO_CATEGORY() \
const auto EnsureCategoryDeclared = true

	// Used to declare a new category
#define BRICK_PROPERTY_CATEGORY(DisplayName) \
	BRICK_PROPERTY_NO_CATEGORY(); \
	...
	{
		for (auto i = 0; i < BrickProperties.Num(); ++i)
		{
